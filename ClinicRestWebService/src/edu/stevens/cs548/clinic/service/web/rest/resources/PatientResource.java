...
public class PatientResource {
	...
	public class PatientRecordNotFound extends WebApplicationException {
		private static final long serialVersionUID = 1L;
		public PatientRecordNotFound(String message) {
	         super(Response.status(Response.Status.NOT_FOUND)
	             .entity(message).type(Representation.MEDIA_TYPE).build());
	     }
	}
	public class PatientRecordNotCreated extends WebApplicationException{
		private static final long serialVersionUID = 1L;
		public PatientRecordNotCreated(String message) {
    ...
    public Response addPatient(PatientRepresentation patientRep) {
    	try {
    		...
    		throw new PatientRecordNotCreated("Unable to add Patient");
    	}
    }
	...
	public PatientRepresentation getPatient(@PathParam("id") String id) {
		try {
			...
			throw new PatientRecordNotFound("Patient Record not found");
		}
	}
    ...
    public TreatmentRepresentation getPatientTreatment(@PathParam("id") String id, @PathParam("tid") String tid) {
    	try {
    		...
    		throw new PatientRecordNotFound("Patient Treatment Record not found");
    	}
    }
